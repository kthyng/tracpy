...
def readfields(tind,grid):
    ...
    Array descriptions:
     ...
     dzt0 			? [imt,jmt]
     dzu,dzv 		Height of each u/v grid cell [imt,jmt,km]
     uflux1,vflux1 	Zonal (x) and meridional (y) fluxes [imt,jmt,km] (m^3/s)?
	'''
